...
addpath('../')
init_simulator_day3; % Change this to the init file corresponding to your helicopter
...
% Bounds
pk_const = 60/360 *pi;
ul 	    = -pk_const;                   % Lower bound on control
uu 	    = pk_const;                   % Upper bound on control
...
P1 = 12;                                % Weight on input, values 0.12, 1, 1.2, 12
