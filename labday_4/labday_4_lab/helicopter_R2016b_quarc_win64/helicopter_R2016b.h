...
#ifndef RTW_HEADER_helicopter_R2016b_h_
#define RTW_HEADER_helicopter_R2016b_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_R2016b_COMMON_INCLUDES_
#define helicopter_R2016b_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_R2016b_COMMON_INCLUDES_ */

#include "helicopter_R2016b_types.h"
...
#define helicopter_R2016b_rtModel      RT_MODEL_helicopter_R2016b_T

/* Block signals (default storage) */
typedef struct {
  real_T FromWorkspace2;               /* '<S6>/From Workspace2' */
  real_T FromWorkspace1[4];            /* '<S6>/From Workspace1' */
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace2_PWORK;              /* '<S6>/From Workspace2' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace2_IWORK;              /* '<S6>/From Workspace2' */
...
#define rtB                            helicopter_R2016b_B
#define BlockIO                        B_helicopter_R2016b_T
#define rtX                            helicopter_R2016b_X
#define ContinuousStates               X_helicopter_R2016b_T
#define rtXdot                         helicopter_R2016b_XDot
#define StateDerivatives               XDot_helicopter_R2016b_T
#define tXdis                          helicopter_R2016b_XDis
#define StateDisabled                  XDis_helicopter_R2016b_T
#define rtP                            helicopter_R2016b_P
#define Parameters                     P_helicopter_R2016b_T
#define rtDWork                        helicopter_R2016b_DW
#define D_Work                         DW_helicopter_R2016b_T

/* Parameters (default storage) */
struct P_helicopter_R2016b_T_ {
...
struct tag_RTM_helicopter_R2016b_T {
  const char_T *path;
...
extern P_helicopter_R2016b_T helicopter_R2016b_P;

/* Block signals (default storage) */
extern B_helicopter_R2016b_T helicopter_R2016b_B;

/* Continuous states (default storage) */
extern X_helicopter_R2016b_T helicopter_R2016b_X;

/* Block states (default storage) */
extern DW_helicopter_R2016b_T helicopter_R2016b_DW;

/* Model entry point functions */
extern void helicopter_R2016b_initialize(void);
extern void helicopter_R2016b_output(void);
extern void helicopter_R2016b_update(void);
extern void helicopter_R2016b_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_R2016b_rtModel *helicopter_R2016b(void);
...
extern RT_MODEL_helicopter_R2016b_T *const helicopter_R2016b_M;
 ...
 *
 * '<Root>' : 'helicopter_R2016b'
 * '<S1>'   : 'helicopter_R2016b/Conversion'
 * '<S2>'   : 'helicopter_R2016b/Degrees to Radians'
 * '<S3>'   : 'helicopter_R2016b/Degrees to Radians1'
 * '<S4>'   : 'helicopter_R2016b/Elevation controller'
 * '<S5>'   : 'helicopter_R2016b/Helicopter_interface'
 * '<S6>'   : 'helicopter_R2016b/LQR_Controller'
 * '<S7>'   : 'helicopter_R2016b/Pitch controller'
 * '<S8>'   : 'helicopter_R2016b/Plots'
 * '<S9>'   : 'helicopter_R2016b/Elevation controller/If Action Subsystem'
 * '<S10>'  : 'helicopter_R2016b/Helicopter_interface/Elevation rad to deg'
 * '<S11>'  : 'helicopter_R2016b/Helicopter_interface/Elevation rate rad to deg'
 * '<S12>'  : 'helicopter_R2016b/Helicopter_interface/Pitch rad to deg'
 * '<S13>'  : 'helicopter_R2016b/Helicopter_interface/Pitch rate rad to deg'
 * '<S14>'  : 'helicopter_R2016b/Helicopter_interface/Pitch rate rad to deg1'
 * '<S15>'  : 'helicopter_R2016b/Helicopter_interface/Travel rad to deg'
 * '<S16>'  : 'helicopter_R2016b/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_R2016b_h_ */
