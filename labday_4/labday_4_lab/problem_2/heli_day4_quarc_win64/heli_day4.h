 ...
 * C source code generated on : Tue Mar 10 14:03:15 2026
 *
...
#ifndef RTW_HEADER_heli_day4_h_
#define RTW_HEADER_heli_day4_h_
#include <math.h>
#include <string.h>
#ifndef heli_day4_COMMON_INCLUDES_
#define heli_day4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_day4_COMMON_INCLUDES_ */

#include "heli_day4_types.h"
...
#define heli_day4_rtModel              RT_MODEL_heli_day4_T

/* Block signals (default storage) */
typedef struct {
  real_T FromWorkspace[2];             /* '<S6>/From Workspace' */
...
#define rtB                            heli_day4_B
#define BlockIO                        B_heli_day4_T
#define rtX                            heli_day4_X
#define ContinuousStates               X_heli_day4_T
#define rtXdot                         heli_day4_XDot
#define StateDerivatives               XDot_heli_day4_T
#define tXdis                          heli_day4_XDis
#define StateDisabled                  XDis_heli_day4_T
#define rtP                            heli_day4_P
#define Parameters                     P_heli_day4_T
#define rtDWork                        heli_day4_DW
#define D_Work                         DW_heli_day4_T

/* Parameters (default storage) */
struct P_heli_day4_T_ {
...
extern P_heli_day4_T heli_day4_P;

/* Block signals (default storage) */
extern B_heli_day4_T heli_day4_B;

/* Continuous states (default storage) */
extern X_heli_day4_T heli_day4_X;

/* Block states (default storage) */
extern DW_heli_day4_T heli_day4_DW;

/* Model entry point functions */
extern void heli_day4_initialize(void);
extern void heli_day4_output(void);
extern void heli_day4_update(void);
extern void heli_day4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_day4_rtModel *heli_day4(void);
...
extern RT_MODEL_heli_day4_T *const heli_day4_M;
 ...
 *
 * '<Root>' : 'heli_day4'
 * '<S1>'   : 'heli_day4/Conversion'
 * '<S2>'   : 'heli_day4/Degrees to Radians'
 * '<S3>'   : 'heli_day4/Degrees to Radians1'
 * '<S4>'   : 'heli_day4/Elevation controller'
 * '<S5>'   : 'heli_day4/Helicopter_interface'
 * '<S6>'   : 'heli_day4/LQR_Controller'
 * '<S7>'   : 'heli_day4/Pitch controller'
 * '<S8>'   : 'heli_day4/Plots'
 * '<S9>'   : 'heli_day4/Elevation controller/If Action Subsystem'
 * '<S10>'  : 'heli_day4/Helicopter_interface/Elevation rad to deg'
 * '<S11>'  : 'heli_day4/Helicopter_interface/Elevation rate rad to deg'
 * '<S12>'  : 'heli_day4/Helicopter_interface/Pitch rad to deg'
 * '<S13>'  : 'heli_day4/Helicopter_interface/Pitch rate rad to deg'
 * '<S14>'  : 'heli_day4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S15>'  : 'heli_day4/Helicopter_interface/Travel rad to deg'
 * '<S16>'  : 'heli_day4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_day4_h_ */
